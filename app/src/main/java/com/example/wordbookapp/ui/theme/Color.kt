...
val SecondaryCoral = oklch(0.66, 0.11, 32.0)
val SecondaryCoralSoft = oklch(0.88, 0.03, 32.0)
val SecondaryCoralContainer = oklch(0.83, 0.04, 32.0)
val DividerSoft = oklch(0.84, 0.012, 250.0)
val CardBorderStrong = oklch(0.76, 0.018, 250.0)